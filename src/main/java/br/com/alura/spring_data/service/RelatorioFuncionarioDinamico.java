...
public class RelatorioFuncionarioDinamico {
    ...
    public void inicial(Scanner scanner){
        ...
        //Essa consulta irá retornar uma lista de funcionarios da base de dados(repository)
        // e irá trazer algo que tenha algo parecido entre o inicio e o fim que o usuario digitar,
        // tipo o like %% do sql
